...
**找 · Source**
你在框里敲"powerpoint"，刷出来一墙长得差不多的结果，按 star 从高到低排。排在第七、只有三十个 star 的那个，其实是把头名重写过一遍、更合你用的版本，可你翻不到它。猎头不在墙上挂广告，也不要你自己憋出完美关键词。你把想干的事说一句人话，他替你翻成搜索、把整个市场捋一遍，连那些根本没挂出来的也带回来。
...
| 阶段 | 猎头术语 | 干什么 | 部门 |
|---|---|---|---|
| **找 Source** | sourcing / talent mapping | 把人话需求拆成关键词多遍搜、跨源、同源拷贝归并、猎回 star 排序埋没的改良版 | `world-aid` |
...
| | 一个搜索框 | skill 猎头公司 |
|---|---|---|
| **找** | 按 star 甩一墙长得差不多的，还得你自己猜对关键词 | 说句人话就出一份短名单，拷贝归并，低星改良版被顶上来 |
